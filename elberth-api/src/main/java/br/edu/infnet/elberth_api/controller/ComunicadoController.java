...
public class ComunicadoController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<Comunicado> obterPorId(
            @PathVariable Long id) {

        Comunicado comunicado =
                comunicadoService.obterPorId(id);
    ...
    @PostMapping
    public ResponseEntity<Comunicado> incluir(
            @Valid
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Comunicado> alterar(
            @PathVariable Long id,
            @Valid
            @RequestBody Comunicado comunicado) {

        Comunicado comunicadoAlterado =
    ...
    public ResponseEntity<List<Comunicado>>
            obterPublicados() {

        return ResponseEntity.ok(
                comunicadoService
                        .obterPublicadosDoBanco()
        );
    }
    ...
    public ResponseEntity<List<Comunicado>>
            buscarPorTitulo(
                    ...
                    @Parameter(
                            description = "Trecho do título do comunicado."
                    )
